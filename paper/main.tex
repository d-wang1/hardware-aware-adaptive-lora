...
\textbf{Shared.} Identical optimizer (AdamW), learning rate
...
reflects activation and optimizer-state peaks during training, not
...
\item \textbf{Single task and single model.} SST-2 with DistilBERT-base
      only. Whether the allocator's behavior generalizes to multi-class
